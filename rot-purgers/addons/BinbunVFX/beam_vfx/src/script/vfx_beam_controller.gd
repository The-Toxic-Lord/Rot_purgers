...
@onready var beam_start: MeshInstance3D = %BeamStart
@onready var beam_pivot: Node3D = %BeamPivot
@onready var beam_scalor: Node3D = %BeamScalor
@onready var beam_core: MeshInstance3D = %BeamCore
@onready var beam_outer: MeshInstance3D = %BeamOuter
@onready var beam_flare1: MeshInstance3D = %BeamFlare1
@onready var beam_flare2: MeshInstance3D = %BeamFlare2
@onready var beam_end_pivot: Node3D = %BeamEndPivot
